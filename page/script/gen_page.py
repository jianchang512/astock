...
def generate_pages() -> None:
    ...
    # 根 index
    index_lines = ["""# Qlib CSI300 \n 点击下方或左侧查看打分预测。\n\n
### **规则 = 可量化的判断条件**

规则名称：低波动价值反转策略

判断条件（规则）：
1. 近20日跌幅在5%-15%之间      → ROC20 ∈ [0.85, 0.95]
2. 近60日波动率低于5%           → STD60 < 0.05
3. 5日成交量小于20日均量        → VMA5 < VMA20
4. 模型预测分数 > 0.02          → avg_score > 0.02
5. 至少70%的模型看涨            → pos_ratio > 0.70
